 ...
 * </p>
 * <ul>
 *   <li>{@link com.extremexp.emf.model.workflow.impl.MetaDataImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.extremexp.emf.model.workflow.impl.MetaDataImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetaDataImpl extends MinimalEObjectImpl.Container implements MetaData {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.META_DATA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.META_DATA__NAME, oldName, name));
	}
