...
public class ConditionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFalsePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_condition_feature",
								"_UI_Condition_type"),
						WorkflowPackage.Literals.CONDITION__CONDITION, true, false, false,
	...
	protected void addTruePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Condition_true_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_true_feature",
								"_UI_Condition_type"),
						WorkflowPackage.Literals.CONDITION__TRUE, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the False feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFalsePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Condition_false_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_false_feature",
								"_UI_Condition_type"),
						WorkflowPackage.Literals.CONDITION__FALSE, true, false, true, null, null, null));
	}
