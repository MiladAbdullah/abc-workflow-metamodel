...
/**
 * This is the item provider adapter for a {@link eu.extremexp.emf.model.workflow.Array} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayItemProvider extends ParameterTypeItemProvider {
	/**
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Array_length_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Array_length_feature", "_UI_Array_type"),
						WorkflowPackage.Literals.ARRAY__LENGTH, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Array_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Array_type_feature", "_UI_Array_type"),
						WorkflowPackage.Literals.ARRAY__TYPE, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Array_type")
