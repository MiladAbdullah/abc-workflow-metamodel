...
public class WorkflowSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case WorkflowPackage.ASSEMBLED_WORFLOW: {
			AssembledWorflow assembledWorflow = (AssembledWorflow) theEObject;
			T result = caseAssembledWorflow(assembledWorflow);
			if (result == null)
				result = caseWorkflow(assembledWorflow);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WorkflowPackage.SUBSTITUTED_TASK: {
			SubstitutedTask substitutedTask = (SubstitutedTask) theEObject;
			T result = caseSubstitutedTask(substitutedTask);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WorkflowPackage.COMPOSITE_WORKFLOW: {
			...
			if (result == null)
				result = caseWorkflow(compositeWorkflow);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case WorkflowPackage.TASK_SPECIFICATION: {
			...
			if (result == null)
				result = caseWorkflow(taskSpecification);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Assembled Worflow</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Assembled Worflow</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAssembledWorflow(AssembledWorflow object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Substituted Task</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Substituted Task</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSubstitutedTask(SubstitutedTask object) {
		return null;
	}
