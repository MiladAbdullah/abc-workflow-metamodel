 ...
 * </p>
 * <ul>
 *   <li>{@link eu.extremexp.emf.model.workflow.impl.TaskSpecificationImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link eu.extremexp.emf.model.workflow.impl.TaskSpecificationImpl#getMetrics <em>Metrics</em>}</li>
 *   <li>{@link eu.extremexp.emf.model.workflow.impl.TaskSpecificationImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskSpecificationImpl extends WorkflowImpl implements TaskSpecification {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.TASK_SPECIFICATION;
	}
	...
	public void setImplementation(String newImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.TASK_SPECIFICATION__IMPLEMENTATION,
	...
	public EList<Metric> getMetrics() {
		if (metrics == null) {
			metrics = new EObjectContainmentEList<Metric>(Metric.class, this,
					WorkflowPackage.TASK_SPECIFICATION__METRICS);
		}
		return metrics;
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this,
					WorkflowPackage.TASK_SPECIFICATION__PARAMETERS);
		}
		return parameters;
	}
