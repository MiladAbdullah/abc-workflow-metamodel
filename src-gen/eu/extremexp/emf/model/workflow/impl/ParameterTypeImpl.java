 ...
 * </p>
 * <ul>
 *   <li>{@link eu.extremexp.emf.model.workflow.impl.ParameterTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ParameterTypeImpl extends MinimalEObjectImpl.Container implements ParameterType {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.PARAMETER_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.PARAMETER_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case WorkflowPackage.PARAMETER_TYPE__NAME:
			return getName();
		}
