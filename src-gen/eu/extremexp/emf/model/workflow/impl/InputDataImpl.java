 ...
 * </p>
 * <ul>
 *   <li>{@link eu.extremexp.emf.model.workflow.impl.InputDataImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputDataImpl extends MinimalEObjectImpl.Container implements InputData {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.INPUT_DATA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.INPUT_DATA__NAME, oldName, name));
	}
