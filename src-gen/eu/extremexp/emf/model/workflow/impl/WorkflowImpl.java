 ...
 * </p>
 * <ul>
 *   <li>{@link eu.extremexp.emf.model.workflow.impl.WorkflowImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.extremexp.emf.model.workflow.impl.WorkflowImpl#getInputs <em>Inputs</em>}</li>
 *   <li>{@link eu.extremexp.emf.model.workflow.impl.WorkflowImpl#getOutputs <em>Outputs</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class WorkflowImpl extends MinimalEObjectImpl.Container implements Workflow {
	...
	public EList<InputData> getInputs() {
		if (inputs == null) {
			inputs = new EObjectContainmentEList<InputData>(InputData.class, this, WorkflowPackage.WORKFLOW__INPUTS);
		}
		return inputs;
	}
	...
	public EList<OutputData> getOutputs() {
		if (outputs == null) {
			outputs = new EObjectContainmentEList<OutputData>(OutputData.class, this,
					WorkflowPackage.WORKFLOW__OUTPUTS);
		}
		return outputs;
	}
